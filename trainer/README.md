...
--nnode=1 --node_rank=0 --nproc_per_node=1  train.py -c config.json -d 0 --local_world_size 1

![image-20230523224928563](README.assets/image-20230523224928563.png)

最好通过以下方式运行，不然可能运行不是配置

![image-20230524215335322](README.assets/image-20230524215335322.png)
