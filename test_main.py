...
if __name__ == '__main__':
    ...
    args.add_argument('-ckpt', '--checkpoint', default='./saved_1115/models/PICK_Default/test_1119_154936/checkpoint-epoch60.pth', type=str,
    ...
    args.add_argument('-output', '--output_folder', default='./test_output', type=str,
